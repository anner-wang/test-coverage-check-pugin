package com.fr.coverage.core.git.service.coverage;
...
public class CoverageService {
    ...
    public UncoveredJsonInfo generateCoverageJsonObj(List<CodeLine> codeLineBeanList, CheckService checkService) {
        int validSum = 0, testedSum = 0;
        UncoveredJsonInfo uncoveredJsonInfo = new UncoveredJsonInfo();
        ...
        uncoveredJsonInfo.setCoverage(coverage);
        uncoveredJsonInfo.setValidLineNumber(validSum);
        uncoveredJsonInfo.setTestedLineNumber(testedSum);
        uncoveredJsonInfo.setDetail(detailMap);
