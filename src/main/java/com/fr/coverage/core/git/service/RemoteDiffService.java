package com.fr.coverage.core.git.service;

import com.fr.coverage.core.bean.RemoteInfo;
import com.fr.coverage.core.git.service.coverage.RepositoryService;
import com.fr.coverage.core.git.service.merge.ShowMergeBaseBranchDiff;
import com.fr.coverage.core.gradle.GradleProject;
...
public class RemoteDiffService implements DiffService {
    ...
    public List<DiffEntry> getDiffList(Repository repository) throws GitAPIException, URISyntaxException {
        ...
        gradleProject.runTasks("coverageReport");
