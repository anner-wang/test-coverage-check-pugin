...
public class Converter {
    ...
    public static RemoteInfo RefStr2RemoteInfo(String refStr, boolean isFromDirection) {
        ...
        gitInfo.setLocalPosition(StrUtil.format("{}{}{}{}{}", Local.BASE_PATH.getValue(), File.separator,
    ...
    public static LocalInfo Args2LocalInfo(String[] args) {
        ...
        LocalInfo localInfo=new LocalInfo(args[0],args[1],args[2]);
        if (args.length > 3) {
            localInfo.setGitGitFileName(args[3]);
        }
